		...
		<ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
			...
			<li class="nav-item dropdown">
				...
				<ul class="dropdown-menu dropdown-user">
					<li>
						<div class="user-box">
							...
							<div class="u-text">
								...
								<p class="text-muted">mail: {{auth()->user()->email}}</p>
                                <p class="text-muted">Tel: {{auth()->user()->telephone}}</p>
							</div>
						</div>
					</li>
					...
					<div class="dropdown-divider"></div>
					<a class="dropdown-item-danger" href="#"><i class="fa fa-power-off"></i> Deconnexion</a>
				</ul>
				<!-- /.dropdown-user -->
			</li>
		</ul>
