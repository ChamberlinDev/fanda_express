                ...
                <div class="card-body p-4">
                    <form>
                        ...
                        <div class="row g-4 mb-4">
                            ...
                            <div class="col-md-6">
                                <div class="border rounded-3 p-3 bg-light h-100">
                                    ...
                                    <input type="text" 
                                           class="form-control form-control-lg border-0 bg-white" 
                                           value="{{ $user->created_at ? \Carbon\Carbon::parse($user->created_at)->format('d/m/Y') : 'N/A' }}" 
                                           readonly>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="d-flex flex-column flex-md-row gap-3 justify-content-between align-items-center pt-3 border-top">
                            <a href="{{ route('superadmin.dashboard') }}" class="btn btn-outline-secondary btn-lg w-100 w-md-auto">
                                <i class="bi bi-arrow-left me-2"></i>Retour au tableau de bord
                            </a>
                            <div class="d-flex gap-2 w-100 w-md-auto">
                                <a href="{{ route('superadmin.profil_edit') }}" class="btn btn-warning btn-lg flex-grow-1">
