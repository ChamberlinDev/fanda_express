        ...
        <div class="col-lg-10 col-xl-8">
            <div class="card shadow-lg border-0">
                ...
                <div class="card-body p-4 p-md-5">
                    <form action="{{route('superadmin.profil_save')}}" method="post">
                        @csrf
                        ...
                        <div class="row g-4 mb-4">
                            <div class="col-md-6">
                                <label for="nom_hotel" class="form-label fw-bold">
                                    <i class="bi bi-building text-primary me-2"></i>Nom
                                ...
                                <div class="input-group input-group-lg">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{old('nom_hotel', $user->nom_complet)}}"
                        ...
                        <div class="d-flex flex-column flex-md-row gap-3 justify-content-between align-items-center pt-3">
                            <a href="{{ route('superadmin.profil') }}" class="btn btn-outline-secondary btn-lg w-100 w-md-auto order-2 order-md-1">
