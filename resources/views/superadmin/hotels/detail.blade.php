...
<div class="container-fluid py-4 px-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="fw-bold mb-1">{{ $hotel->nom }}</h2>
    ...
    @else
        <div class="bg-light rounded-3 d-flex align-items-center justify-content-center mb-4"
             style="height: 220px;">
            <div class="text-center text-muted">Aucune image disponible</div>
        </div>
    @endif
                ...
                <div class="card-body">
                    <ul class="list-unstyled mb-0">
                        ...
                        <li class="mb-3">
                            ...
                            <span class="fw-bold">{{ $hotel->nom }}</span>
                        </li>
                        ...
                        <li class="mb-3">
                            ...
                            <span class="small">{{ $hotel->description ?? 'Aucune description.' }}</span>
                        </li>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center gap-3">
                        <div class="bg-primary text-white rounded-circle d-flex align-items-center justify-content-center"
                             style="width:48px; height:48px; font-size:1.1rem; font-weight:bold;">
                            {{ strtoupper(substr($hotel->user->name, 0, 1)) }}
                        </div>
                        <div>
                            <div class="fw-bold">{{ $hotel->user->name }}</div>
        ...
        <div class="col-md-8">
            <div class="card shadow border-0">
                <div class="card-header bg-primary text-white py-3 d-flex justify-content-between align-items-center">
                    <h6 class="mb-0">
                        Réservations
                        <span class="badge bg-white text-primary ms-2">{{ $reservations->count() }}</span>
                    </h6>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover align-middle mb-0">
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            ...
                                            <div>
                                                ...
                                                <small class="text-muted">{{ $r->telephone ?? '—' }}</small>
                                            </div>
                                        </div>
                                    </td>
                            ...
                            <tfoot class="table-dark">
                                <tr>
                                    <td colspan="6" class="text-end fw-bold small">Total encaissé :</td>
